...
export default class OCR extends Component<Props> {
    ...
    processImage = async (uri, imageProperties) => {
        try {
            ...
            textRecieved.push(JSON.stringify(visionResp.text));

            console.log(visionResp);
            //console.log(typeof visionResp);
        ...
        return (
            <View style={style.screen}>
                ...
                {this.state.image ?(
                    ...
                    { Object.entries(textRecieved).map((text, key)=>(
                        <Text key={text} style={styles.loginText} > { text } </Text>)
                    )}
